...
class Cartesian1DTests(unittest.TestCase):
    ...
    def test_flip0(self):
        ...
        self.assertEqual(c.flip0(), c)
        c = coordsys.Cartesian1D((1,))
        self.assertEqual(c.flip0(), (-1,))
        c = coordsys.Cartesian1D((5,))
        self.assertEqual(c.flip0(), (-5,))
    ...
    def test_flip(self):
        ...
        self.assertEqual(c0.flip(p), c2)
        self.assertEqual(c2.flip(p), c0)
        self.assertEqual(p.flip(p), p)
        self.assertEqual(c5.flip(p), (-3,))
...
class Cartesian2DTests(unittest.TestCase):
    ...
    def test_rotate0(self):
        for r in range(4):
            self.assertEqual(self.o.rotate0(r), self.o)
        for r in range(4):
            self.assertEqual(self.c.rotate0(r), self.rotated['c/0'][r])

    def test_rotate(self):
        for r in range(4):
            self.assertEqual(self.o.rotate(r, self.o), self.o)
        for r in range(4):
            self.assertEqual(self.o.rotate(r, self.p), self.rotated['o/p'][r])
        for r in range(4):
            self.assertEqual(self.c.rotate(r, self.p), self.rotated['c/p'][r])

    def test_arithmetic(self):
        self.assertEqual(self.o + self.c, self.c)
        self.assertEqual(self.c + self.p, (3,6))
        self.assertEqual(self.c - self.p, (1,4))
        self.assertEqual(self.p - self.c, (-1, -4))
...
class Hexagonal2DTests(unittest.TestCase):
    ...
    def test_flip0(self):
        self.assertEqual(self.o.flip0(), self.o)
        self.assertEqual(self.c01.flip0(), self.c01)
        self.assertEqual(self.c10.flip0(), (-1,1))
        self.assertEqual(self.c11.flip0(), (-1,2))
        c = coordsys.Hexagonal2D((2,-1))
        self.assertEqual(c.flip0(), (-2,1))

    def test_flip(self):
        self.assertEqual(self.o.flip(self.o), self.o)
        self.assertEqual(self.c01.flip(self.o), self.c01)
        self.assertEqual(self.c10.flip(self.o), (-1,1))
        self.assertEqual(self.c11.flip(self.o), (-1,2))

        self.assertEqual(self.o.flip(self.c11), (2,-1))
        self.assertEqual(self.c01.flip(self.c11), (2,0))
        self.assertEqual(self.c10.flip(self.c11), self.c10)
        self.assertEqual(self.c11.flip(self.c11), self.c11)

    def test_rotate0(self):
        for r in range(6):
            self.assertEqual(self.o.rotate0(r), self.o)
        for r in range(6):
            self.assertEqual(self.c10.rotate0(r), self.rotated['c10/0'][r])

    def test_rotate(self):
        for r in range(6):
            self.assertEqual(self.c10.rotate(r, self.o),
                              self.rotated['c10/0'][r])
        for r in range(6):
            self.assertEqual(self.c23.rotate(r, self.c11),
...
class Triangular3DTests(unittest.TestCase):
    ...
    def test_flip0(self):
        self.assertEqual(self.o.flip0(), self.o)
        self.assertEqual(self.c100.flip0(), (-1,0,0))

    def test_rotate0(self):
        o = self.o
        for r in range(6):
            self.assertEqual(self.o.rotate0(r), self.o_rotated[r])
            o = o.rotate0(1)
            self.assertEqual(o, self.o_rotated[(r + 1) % 6])
        c = self.c100
        for r in range(6):
            self.assertEqual(self.c100.rotate0(r), self.rotated['c100/0'][r])
            c = c.rotate0(1)
            self.assertEqual(c, self.rotated['c100/0'][(r + 1) % 6])
...
class SquareGrid3DTests(unittest.TestCase):
    ...
    def test_flip0(self):
        self.assertEqual(self.o.flip0(), (-1,0,0))
        self.assertEqual(self.c100.flip0(), (-2,0,0))
    ...
    def test_rotate0(self):
        ...
        for r in range(4):
            self.assertEqual(self.o.rotate0(r), self.o_rotated[r])
            o = o.rotate0(1)
            self.assertEqual(o, self.o_rotated[(r + 1) % 4])
        c = self.c100
        for r in range(4):
            self.assertEqual(self.c100.rotate0(r), self.rotated['c100/0'][r])
            c = c.rotate0(1)
            self.assertEqual(c, self.rotated['c100/0'][(r + 1) % 4])
        c = self.c111
        for r in range(4):
            self.assertEqual(self.c111.rotate0(r), self.rotated['c111/0'][r])
            c = c.rotate0(1)
            self.assertEqual(c, self.rotated['c111/0'][(r + 1) % 4])
...
class TriangularGrid3DTests(unittest.TestCase):
    ...
    def test_flip0(self):
        self.assertEqual(self.o.flip0(), (0,0,2))
        self.assertEqual(self.c100.flip0(), (-1,1,2))
        self.assertEqual(self.c111.flip0(), (-1,2,1))
    ...
    def test_rotate0(self):
        ...
        for r in range(6):
            self.assertEqual(self.c111.rotate0(r), self.rotated['c111/0'][r])
            c = c.rotate0(1)
            self.assertEqual(c, self.rotated['c111/0'][(r + 1) % 6])

    def test_view(self):
        v = coordsys.TriangularGrid3DView(self.p)
        for r in range(7):
            v = v.rotate0(1)
            self.assertEqual(v, set(self.p_rotated[(r + 1) % 6]))
...
class HexagonalGrid3DTests(unittest.TestCase):
    ...
    def test_flip0(self):
        self.assertEqual(self.o.flip0(), (0,0,0))
        self.assertEqual(self.c100.flip0(), (-1,1,0))
        self.assertEqual(self.c111.flip0(), (0,2,2))
