...
class OneSidedPolytrigs123Trapezoid7x4(OneSidedPolytrigs123):
    ...
    def coordinates(self):
        hole = {(3,1,1), (3,1,2), (2,2,0), (2,2,1), (3,2,2)}
